        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <AnimatedSection delay={200}>
            <div className="space-y-6">
                ...
                <ul className="space-y-5">
                  <li>
                    ...
                    >
                      ...
                      <div>
                        <p className="text-white/70 text-sm mb-0.5">الهاتف</p>
                  ...
                  <li className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-white/70 text-sm mb-0.5">الموقع</p>
              ...
              {/* WhatsApp CTA */}
              <a
                href={`https://wa.me/966${contactInfo.phone.slice(1)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-[#25D366] text-white rounded-2xl font-bold text-base hover:bg-[#20BD5A] hover:-translate-y-0.5 transition-all duration-300 shadow-lg shadow-[#25D366]/20"
              >
                <svg
